  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8">
        <h2 className="text-2xl font-bold text-blue-800 mb-6">Add Document</h2>

        <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-md">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Document Name */}
            <div>
              <label className="block font-medium text-sm text-gray-700">Document Name<span className="text-red-500">*</span></label>
              <input
                type="text"
                name="documentName"
            ...
            {/* File Upload */}
            <div>
              <label className="block font-medium text-sm text-gray-700">Select File<span className="text-red-500">*</span></label>
              <input
                type="file"
                name="file"
                required
